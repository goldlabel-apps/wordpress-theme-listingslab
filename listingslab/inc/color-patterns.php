 ...
 */
function listingslab_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Listingslab default saturation level.
	 *
	 * @since Listingslab Theme 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'listingslab_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.listingslab-front-page) .entry-title,
...
.colors-custom .listingslab-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.listingslab-front-page .panel-content .recent-posts article,
...
.colors-custom.listingslab-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Listingslab custom colors CSS.
	 *
	 * @since Listingslab Theme 1.0
	 *
	 ...
	 */
	return apply_filters( 'listingslab_custom_colors_css', $css, $hue, $saturation );
}
